(function ($) {
  ...
  jQuery(document).on("ready", function () {
    ...
    function mainSlider() {
      var BasicSlider = $(".modularize-banner-slide");
      var BasicSlider2 = $(".modularize-banner-area-layout-2");
      BasicSlider.on("init", function (e, slick) {
        var $firstAnimatingElements = $(
          ".modularize-banner-slide-active:first-child"
        ).find("[data-animation]");
        doAnimations($firstAnimatingElements);
      });
      BasicSlider2.on("init", function (e, slick) {
        var $firstAnimatingElements = $(
          ".modularize-banner-slide-item:first-child"
        ).find("[data-animation]");
        doAnimations($firstAnimatingElements);
      });
      ...
      BasicSlider.on(
        ...
        function (e, slick, currentSlide, nextSlide) {
          var $animatingElements = $(
            '.modularize-banner-slide-active[data-slick-index="' +
              nextSlide +
              '"]'
          ).find("[data-animation]");
      ...
      BasicSlider2.on(
        ...
        function (e, slick, currentSlide, nextSlide) {
          var $animatingElements = $(
            '.modularize-banner-slide-item[data-slick-index="' +
              nextSlide +
              '"]'
          ).find("[data-animation]");
          doAnimations($animatingElements);
    ...
    //===== client slide v1 js
    $(".modularize-feature-slide").slick({
      arrows: false,
      dots: false,
      infinite: true,
      slidesToShow: 5,
    ...
    //===== client slide v1 js
    $(".modularize-project-slide").slick({
      arrows: false,
      dots: true,
      infinite: true,
      slidesToShow: 4,
    ...
    //===== client slide v1 js
    $(".modularize-project-slide-2").slick({
      arrows: false,
      dots: true,
      infinite: true,
      slidesToShow: 2,
    ...
    //===== client slide v1 js
    $(".modularize-sponser-slide").slick({
      arrows: false,
      dots: false,
      infinite: true,
      slidesToShow: 5,
    ...
    //===== client slide v1 js
    $(".modularize-testimonial-slide").slick({
      arrows: false,
      dots: true,
      infinite: true,
      slidesToShow: 2,
    ...
    //===== client slide v1 js
    $(".modularize-blog-slide-active").slick({
      arrows: false,
      prevArrow:
        '<span class="prev"><i class="fal fa-long-arrow-left"></i></span>',
      nextArrow:
    ...
    //===== client slide v1 js
    $(".modularize-sponser-slide-3").slick({
      arrows: false,
      prevArrow:
        '<span class="prev"><i class="fal fa-long-arrow-left"></i></span>',
      nextArrow:
